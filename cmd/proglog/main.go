...
import (
	"github.com/retocode/proglog/internal/agent"
...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().StringSlice("start-join-addrs", nil, "Serf adresses to join.")
	...
	cmd.Flags().String("peer-tls-ca-file", "", "Path to to peer certificate authority.")
...
func (c *cli) setupConfig(cmd *cobra.Command, args []string) error {
	...
	if err = viper.ReadInConfig(); err != nil {
		// it'sok if config file doesn't exist
	...
	c.cfg.Bootstrap = viper.GetBool("boostrap")
	...
	if c.cfg.ServerTLSConfig.CAFile != "" &&
