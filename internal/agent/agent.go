...
import (
	...
	"github.com/retocode/proglog/internal/discovery"
	"github.com/retocode/proglog/internal/log"
...
func (a *Agent) setupLog() error {
	// filter out raft connections on multiplexed port
...
func (a *Agent) setupServer() error {
	...
	// raft connection is already filtered, other connections are GRPC
